...
import com.yagna.petra.app.Payment.DlgProductAdapter;
import com.yagna.petra.app.Payment.PayMentProductAdapter;
 ...
 */
public class TransactionListViewAdapter extends BaseAdapter implements Filterable {
    private final SharedPreferences common_mypref;
    LayoutInflater inflater;
    TransactionListActivity context;
    ArrayList<Transaction>  jsonarray;
    ArrayList<Transaction>  jsonarrayOne;


    public TransactionListViewAdapter(TransactionListActivity mainActivity, ArrayList<Transaction> jarry) {
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        holder.ly_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    TransactionListActivity.click_transaction=jsonarray.get(position);
                    intent.putExtra("data",""+(position));
                    dialogFullTransaction(TransactionListActivity.click_transaction);
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public Filter getFilter() {
        Filter filter = new Filter() {
                    ...
                    if (constraint == null || constraint.length() == 0) {
                        ...
                        for (int i = 0; i < jsonarrayOne.size(); i++) {
                            ...
                            if (dataTid.contains(constraint.toString())) {
                                filteredJsonarray.put(putObj);
                            }
                        }
                        results.count = filteredJsonarray.length();
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                ...
                ArrayList<Transaction> jsonarray = (ArrayList<Transaction>)filterResults.values;
    ...
    public void dialogFullTransaction(Transaction transaction) {
        ...
        ((TextView)rowView.findViewById(R.id.txt_cashier)).setText(transaction.cashier_name);
        ...
        rv_list.setAdapter(new DlgProductAdapter(context, DataKeeper.products_array));
