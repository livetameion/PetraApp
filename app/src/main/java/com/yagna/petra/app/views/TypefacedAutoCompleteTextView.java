...
public class TypefacedAutoCompleteTextView extends android.support.v7.widget.AppCompatAutoCompleteTextView {
	...
	public TypefacedAutoCompleteTextView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init(Context context, AttributeSet attrs) {
		if (!isInEditMode()) {
			TypedArray styledAttrs = context.obtainStyledAttributes(attrs, R.styleable.TypefacedAutoCompleteTextView);
			int index = styledAttrs.getInt(R.styleable.TypefacedAutoCompleteTextView_customTypeface, 1);
			setFont(index);
			styledAttrs.recycle();
		}
	}
